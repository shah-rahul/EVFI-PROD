...
class _CustomMarkerPopupState extends State<CustomMarkerPopup> {
  ...
  Widget callContent() {
    if (isBooking) {
      ...
      return bookingSection(context);
    } else {
      print('content book-slot');
  ...
  return Column(
    ...
    children: [
      const Text('Charger Type',
          style: TextStyle(fontSize: AppSize.s16, fontWeight: FontWeight.w500)),
      Row(
        ...
        children: [
          Container(
            ...
            child: ElevatedButton(
              onPressed: () {},
              style: const ButtonStyle(
                  backgroundColor: MaterialStatePropertyAll(Color.fromARGB(255, 88, 222, 92))),
              child: const Text(
                'Proceed to Pay',
                style: TextStyle(
