...
String convertTime(int startHour) {
    ...
    int displayStartHour = (startHour > 12) ? startHour - 12 : startHour;
    int displayEndHour = (endHour > 12) ? endHour - 12 : endHour;

    // Format the time strings
    String displayStartTime =
        '${displayStartHour.toString().padLeft(2, '0')}:00 ${period}';
    String displayEndTime =
        '${displayEndHour.toString().padLeft(2, '0')}:00 ${(period == 'AM' && displayEndHour == 0) ? 'AM' : 'PM'}';
